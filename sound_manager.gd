...
func play_music(resource: AudioStream, crossfade_duration: float = 0.0, override_bus: String = "") -> AudioStreamPlayer:
	return music.play(resource, linear_to_db(1.0), crossfade_duration, override_bus)


func swap_music(resource: AudioStream) -> AudioStreamPlayer:
	return music.swap(resource)


func play_music_at_volume(resource: AudioStream, volume_between_0_and_1: float = 0.0, crossfade_duration: float = 0.0, override_bus: String = "") -> AudioStreamPlayer:
	return music.play(resource, linear_to_db(volume_between_0_and_1), crossfade_duration, override_bus)
